...
class ClickHandlerMusicXml {
     ...
     * 
     * @param {String} xmlString  raw score coming from text editor
    ...
    /**
     * Build a map that associates each MusicXML <part> element to the number of their first music staff.
     * Staff number begins at 1.
     * 
     * @param {XMLDocument} xmlDoc MusicXML score
  ...
  getIdOfItemAtCursor(text, cursorPosition) {
    ...
    var line = text.lineForRow(row);

    //// MusicXML (partwise) without ID
